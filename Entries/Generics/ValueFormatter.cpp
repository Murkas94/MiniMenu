...
using namespace MiniMenu::Generics;

String DefaultFormatter::Format(const void* data, ValueType valueType)
{
    String text = Prefix;
    switch (valueType)
    {
...
String PercentFormatter::Format(const void* data, ValueType valueType)
{
    switch (valueType)
    {
    case ValueType::int64:
...
String TimeFromSecondsFormatter::Format(const void* data, ValueType valueType)
{
    switch (valueType)
    {
    case ValueType::int64:
...
String TimeFromMillisecondsFormatter::Format(const void* data, ValueType valueType)
{
    switch (valueType)
    {
    case ValueType::int64:
...
String TimeFromSecondsFormatter::GetTimeString(int64_t seconds)
{
    String result;
