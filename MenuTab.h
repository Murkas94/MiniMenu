...
public:
    ...
    MenuTab& SetFixedEntryCount(uint8_t count){ fixedEntryCount = count; return *this; }
    ...
    MenuEntry* GetEntry(int16_t index){ if(index < entries.size()){return entries[index];} return nullptr;}
};
}
